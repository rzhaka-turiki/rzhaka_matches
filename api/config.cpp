...
std::string Config::db_connection_string() const { return data_.at("db_connection").get<std::string>(); }

std::string Config::api_base_url() const { return data_.at("api_base_url").get<std::string>(); }
